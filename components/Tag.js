...
const Tag = ({ text, children }) => {
  return (
    ...
    >
      {text && (
        <div className="flex w-full content-center justify-between rounded-lg border border-primary-700 bg-white py-1 px-3 text-xs font-semibold text-primary-500 group-hover:bg-primary-500 group-hover:text-gray-100 dark:border-primary-500 dark:bg-gray-900 lg:text-sm">
