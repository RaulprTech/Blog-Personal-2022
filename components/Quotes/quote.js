    ...
    <section className="my-4 flex cursor-default flex-col">
      <blockquote className="rounded-md bg-gray-200 p-6 dark:bg-gray-800">
        <div className="text-md relative md:flex-grow">
          ...
          <Link href="https://www.instagram.com/p/CDrlWijjYTN/?utm_source=ig_web_copy_link">
        ...
        <footer className="mt-1">
          <p className="text-sm text-neutral-500 dark:text-neutral-500">Mahatma Gandhi</p>
        </footer>
      </blockquote>
    </section>
  )
